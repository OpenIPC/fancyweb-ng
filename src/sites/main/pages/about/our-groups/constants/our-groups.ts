export const ourGroupsConstants = {
  ...
  chats: [
    ...
    { header: 'OpenIPC & FPV (EN)', link: 'https://t.me/+BMyMoolVOpkzNWUy', text: 'OpenIPC for building FPV systems' },
    { header: 'OpenIPC Users (RU)', link: 'https://t.me/+Sl2GPoR9G2iJAOCr', text: 'Russian-speaking OpenIPC users channel' },
    { header: 'OpenIPC Firmware', link: 'https://t.me/s/openipc_dev', text: 'GitHub notifications on the latest builds' },
  ],
};
